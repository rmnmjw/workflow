...
APP_NAME     := "Teams"
APP_SELECTOR := "Microsoft Teams ahk_class Chrome_WidgetWin_1 ahk_exe brave.exe"
...
class App {
    ...
    launch() {
        ...
        App.counter := 3
        App.init := true
        Run, "C:\Program Files\BraveSoftware\Brave-Browser\Application\chrome_proxy.exe"  --profile-directory=Default --app-id=nfecgfopkdiicnnmccikafaofaoffegm
        if (App.init) {
            App.init := false
            WinWait, App
            Sleep, 1000
