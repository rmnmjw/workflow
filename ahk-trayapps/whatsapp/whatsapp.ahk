...
APP_NAME     := "WhatsApp"
APP_SELECTOR := "WhatsApp ahk_class Chrome_WidgetWin_1 ahk_exe brave.exe"
...
class App {
    ...
    launch() {
        ...
        App.counter := 3
        App.init := true
        Run, "C:\Program Files\BraveSoftware\Brave-Browser\Application\chrome_proxy.exe"  --profile-directory=Default --app-id=hnpfjngllnobngcgfapefoaidbinmjnm
        if (App.init) {
            App.init := false
            WinWait, App
            Sleep, 1000
